...
In this repository, this directory is **not** a standalone flake.
The nixCats config is consumed by the repo's top-level flake via flake-parts.

From the repo root:

- Build: `nix build .#nvim`
- Run: `nix run .#nvim`
- Dev shell: `nix develop .#nvim`
