...
SCRIPT_DIR="/home/zayron/.dotfiles/user/desktop/rofi/scripts/executables"
...
chosen=$(echo -e "$MENU_ENTRIES" | rofi -dmenu -markup-rows -theme "/home/zayron/.dotfiles/user/desktop/rofi/themes/style-4.rasi" -i -p "Select Script:")
